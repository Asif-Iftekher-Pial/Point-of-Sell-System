...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">Category ID- {{ $getData->id }} !</h4>
            ...
            <div class="panel-body">
                ...
                <div class="form">
                    <form class="cmxform form-horizontal tasi-form" id="commentForm" method="post"
                        action="{{ route('category.update', $getData->id) }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control "  type="text" name="name"
                                    placeholder="{{ $getData->name }}" aria-required="true">
                            </div>
                        </div>
